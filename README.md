...
- [**Тестовое задание от Digital агентства Победа**](https://github.com/AntistesEM/Digital_agency_Pobeda-taskTest): Список пользователей – это простое веб-приложение для отображения пользователей и информации о каждом, а также для добавления новых пользователей. Бэкенд разработан на Flask, а фронтенд – на JavaScript. Взаимодействие между частями осуществляется через Fetch API. Используемая база данных SQLite.
    <p align="center">
      <img src="https://github.com/AntistesEM/Digital_agency_Pobeda-taskTest/blob/main/imageWork/%D0%90%D0%BD%D0%B8%D0%BC%D0%B0%D1%86%D0%B8%D1%8F_%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B.gif" alt="Приложение Список пользователей" width="300">
    </p>
- [**Barbershop Kety**](https://github.com/AntistesEM/Barbershop_Kety): Barbershop_Kety — это лендинг для парикмахерской, который показывает информацию об услугах и мастерах, принимает отзывы и отображает медиа.
Бэкенд реализован на Django (шаблоны, маршруты, модели и опционально API через Django REST Framework), фронтенд — классические HTML/CSS/JS в шаблонах и static-папках. Для разработки используется локальная база данных SQLite, а для хранения загружаемых файлов — папка media. Взаимодействие клиентской части с сервером через обычную отправку форм или через Fetch/AJAX к API-эндпоинтам.
    <p align="center">
      <img src="https://github.com/AntistesEM/Barbershop_Kety/blob/main/assets/Animation_of_work.gif" alt="Barbershop_Kety" width="300">
    </p>
